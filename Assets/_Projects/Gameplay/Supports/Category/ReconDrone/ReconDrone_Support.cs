...
{
    public class ReconDrone_Support : Support, IControlMachineAbility
    {
        [SerializeField] private ReconDrone_Machine _machine;

        public ReconDrone_Machine Machine => _machine;
