...
{
    public class HellFlamethrower_Ability : CharacterAbility, IControlMachineAbility
    {
        [SerializeField] private HellFlamethrower_Machine _machine;

        public HellFlamethrower_Machine Machine => _machine;
