...
{
    public class FirebaitBomb_Ability : CharacterAbility, IControlMachineAbility
    {
        [SerializeField] private FirebaitBomb_Machine _machine;

        public FirebaitBomb_Machine Machine => _machine;
        ...
        public override void Initialize()
        {
            base.Initialize();
            Machine.Initialize();
            Machine.ExplosionCooldown.SetBaseTime(DespawnTime.BaseTime - 0.1f);
