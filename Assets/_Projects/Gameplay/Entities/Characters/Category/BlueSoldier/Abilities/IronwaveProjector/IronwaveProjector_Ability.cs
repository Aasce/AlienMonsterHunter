...
{
    public class IronwaveProjector_Ability : CharacterAbility, IControlMachineAbility
    {
        [SerializeField] private IronwaveProjector_Machine _machine;

        public IronwaveProjector_Machine Machine => _machine;
