...
namespace Asce.Game.Entities.Machines
{
    ...
    public class AerialVanguard_Machine : Machine, IMachineFireable
    {
        [Header("References")]
        ...
        private void AttackHandle()
        {
            ...
            this.Fire(barrelPosition, direction);
        ...
        public void Fire(Vector2 position, Vector2 direction)
        {
            ...
            int count = Physics2D.RaycastNonAlloc(position, direction, _cacheHits, _bulletDistance, TargetDetection.SeeLayer);
        ...
        private Vector2 GetBarrelPosition()
        {
