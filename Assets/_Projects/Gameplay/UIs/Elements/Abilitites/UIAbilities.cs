...
namespace Asce.Game.UIs.Elements
{
    public class UIAbilities : UIComponent
    {
        ...
        [SerializeField] private UIHighlightGroup _highlightGroup;
        ...
        private void Start()
        {
            _details.OnHide += Details_OnHide;
        }
        ...
        private void Details_OnHide(object sender)
        {
            _highlightGroup.ClearHighlight();
        }
    }
}
